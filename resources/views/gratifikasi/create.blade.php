<x-app-layout>
    ...
    <div class="p-6 bg-white">
        {{-- -----------form--------------------- --}}
        <form class="row g-3 needs-validation" novalidate method="POST" action="{{ route('gratifikasi.store') }}">
            @csrf
            ...
            <div class="col-md-6 position-relative">
                ...
                <select class="form-select" id="jenis" name="jenis" required>
                    ...
                    @foreach ($jenis as $j)
                        <option @if (old('jenis') == $j->jenis) selected @endif value="{{ $j->jenis }}">{{ $j->jenis }}</option>
                    @endforeach
                </select>
            ...
            <div class="col-md-6 position-relative">
                ...
                <input type="text" class="form-control bg-white" id="bentuk" name="bentuk" value="{{ old('bentuk') }}"
            ...
            <div class="col-md-6 position-relative">
                ...
                <input type="number" class="form-control bg-white" id="nilai" name="nilai" value="{{ old('nilai') }}"
            ...
            <div class="col-md-6 position-relative" id="datepicker4">
                ...
                <input type="date" class="form-control bg-white" id="waktu" name="waktu" value="{{ old('waktu') }}"
                    min="2021-07-01" max="2021-12-31" required>
                <div class="invalid-tooltip">
                    Waktu harus diisi
                </div>
                @error('waktu')
            ...
            <div class="col-md-6 position-relative">
                ...
                <input class="form-control" id="jabatan" name="jabatan"
                    placeholder="Jabatan penerima ketika menerima gratifikasi" required value="{{ old('jabatan') }}">
            ...
            <div class="col-md-6 position-relative">
                ...
                <input type="text" class="form-control bg-white" id="nama" name="nama"
                    placeholder="Nama pemberi gratifikasi" required value="{{ old('nama') }}">
                <div class="invalid-tooltip">
            ...
            <div class="col-md-6 position-relative">
                ...
                <input type="text" class="form-control bg-white" id="hubungan" name="hubungan"
                    placeholder="Hubungan pemberi dan penerima gratifikasi" required value="{{ old('hubungan') }}">
                <div class="invalid-tooltip">
            ...
            <div class="col-md-6 position-relative">
                ...
                <input type="text" class="form-control bg-white" id="alamat" name="alamat"
                    placeholder="Alamat pemberi gratifikasi" required value="{{ old('alamat') }}">
                <div class="invalid-tooltip">
            ...
            <div class="col-md-6 position-relative">
                ...
                <input type="text" class="form-control bg-white" id="alasan" name="alasan"
                    placeholder="Alasan pemberian gratifikasi" required value="{{ old('alasan') }}">
                <div class="invalid-tooltip">
            ...
            <div class="col-md-12 position-relative">
                ...
                <input type="text" class="form-control bg-white" id="keterangan" name="keterangan"
                    placeholder="Keterangan lainnya" value="{{ old('keterangan') }}">
            </div>
